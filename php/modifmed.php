        ...
        if (preg_match("/^[a-zA-Z\S ]+$/", $nom))
        {
			if (preg_match("/^[a-zA-Z\S ]+$/", $prenom))
            {
                if (!empty($login) AND !empty($mopass))
                {
                    ...
                    $req='REPLACE INTO `medecin`(`id_medecin`,`nom`, `prenom`, `email`, `login`, `mopass`, `id_service`, `id_specialite`, `id_admin`) VALUES (?,?,?,?,?,?,?,?,?)';
...
<body>
	...
	<form method="post" action="">
        <table>
            <tr><td><label for="id_medecin">ID_Medecin<input type="ID" name="id_medecin"></label></br></br></br></td></tr>
